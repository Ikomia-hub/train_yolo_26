...
from train_yolo_26.train_yolo_26_process import TrainYolo26Param

# PyQt GUI framework
from PyQt5.QtWidgets import *


class TrainYolo26Widget(core.CWorkflowTaskWidget):
    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = TrainYolo26Param()
        else:
...
class TrainYolo26WidgetFactory(dataprocess.CWidgetFactory):
    def __init__(self):
    ...
    def create(self, param):
        return TrainYolo26Widget(param, None)
